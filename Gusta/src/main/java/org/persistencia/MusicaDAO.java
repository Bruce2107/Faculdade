...
public class MusicaDAO implements DAO<Musica>  {
	...
	private final PreparedStatement selectMusicasPlaylist;
	private final PreparedStatement insert;
	private final PreparedStatement delete;
	private final PreparedStatement deleteMusicaUsuario;
	private final PreparedStatement deleteMusicaPlaylist;
	...
	public List<Integer> selectMusicasPlaylist(int playlist) throws Exception{ //retorna uma lista de ids das m�sicas da playlist passada como par�metro
		selectMusicasPlaylist.setInt(1, playlist);
		ResultSet rs = selectMusicasPlaylist.executeQuery();
	    List<Integer> ids_musicas = new LinkedList<>();
	    while(rs.next()) {
