...
public class PlaylistDAO {
	...
	private static final MusicaDAO musicaDAO = null;

	
	
	private final PreparedStatement selectNewId;
	private final PreparedStatement insert; //cria a playlist
	private final PreparedStatement selectNewIdMusicaPlaylist;
	private final PreparedStatement insertMusicaPlaylist; //insere uma musica em uma playlist
	private final PreparedStatement delete; //exclui a playlist
	private final PreparedStatement deleteMusicasPlaylist; //remove todas as musicas de uma playlist que vai ser excluida
	private final PreparedStatement deletePlaylistUsuario;
	private final PreparedStatement deleteMusicaPlaylist; //remove uma musica de uma playlist
	private final PreparedStatement selectAll; //busca todas as playlists

	private final PreparedStatement update; //edita nome da playlist
	...
	private PlaylistDAO() throws ClassNotFoundException, SQLException {
		...
		PreparedStatement selectAllPlaylists = conexao.prepareStatement("select * from playlist");
